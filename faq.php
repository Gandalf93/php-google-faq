...
<body>
    <header>
        ...
        <div class="container-logo">
            ...
            <span class="scritta-logo">Privacy e Termini</span>
        </div>

        <div>
            <ul class="text-capitalize d-flex flex-row text-secondary border-bottom border-secondary">
                <li>introduzione</li>
                <li>norme sulla privacy</li>
                <li>termini di servizio</li>
                <li>tecnologie</li>
                <li class="selezionato text-primary border-bottom border-primary pb-3">domande frequenti</li>
            </ul>
    ...
    <main>
        <div>
            ...
            <!-- DOMANDE -->
            <?php foreach($faq as $domRis){ ?>

                    <?php foreach($domRis['domanda'] as $domanda){?>
                        <h2>
                            <?php echo $domanda;  ?>
                            <?php } ?>
                        </h2>
            ...
            <!-- RISPOSTE -->
                    ...
                    <?php foreach($domRis['risposta'] as $risposta){?>
                        <p>
                            <?php echo $risposta;  ?>
                        </p>
                    <?php } ?>
    ...
    <footer>
        <div>
            <ul class="text-capitalize text-secondary d-flex flex-row align-items-center">
                <li>google</li>
